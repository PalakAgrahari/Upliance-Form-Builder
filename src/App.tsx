      ...
      MuiCssBaseline: {
        styleOverrides: {
          ...
          "*::-webkit-scrollbar-thumb:hover": {
            background: mode === "light" ? "#b0b4ba" : "#565b60",
          },
        },
      },
      MuiAppBar: {
        ...
        styleOverrides: {
          root: {
            ...
            "&:before": {
              ...
              inset: 0,
              background:
                "linear-gradient(145deg, rgba(255,255,255,0) 20%, rgba(0,120,212,0.04))",
              pointerEvents: "none",
            },
            "&:hover": {
              boxShadow:
                "0 10px 24px -4px rgba(0,0,0,0.18), 0 4px 8px -2px rgba(0,0,0,0.08)",
