...
import {
  saveDraftForm,
  loadDraftForm as loadDraftFromStorage,
  clearDraftForm,
  hasDraftForm,
} from "../../utils/autoSave";
...
const FormBuilder: React.FC = () => {
  ...
  const handleDrop = (e: React.DragEvent, dropIndex: number) => {
    ...
    if (container) {
      container
        .querySelectorAll(".fb-field-card")
        .forEach((el) => el.classList.remove("fb-drop-animate"));
    ...
    <Box sx={{ maxWidth: 800, mx: "auto" }}>
      ...
      {showDraftAlert && (
        <Alert
          ...
          action={
            <Box sx={{ display: "flex", gap: 1 }}>
              ...
              <Button size="small" onClick={handleDismissDraft} color="inherit">
                Dismiss
              </Button>
            </Box>
          }
        >
          ...
          You have an unsaved form draft. Would you like to restore it and
          continue editing?
        </Alert>
      )}
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <FormIcon sx={{ fontSize: 40, mr: 2, color: "#fff" }} />
          <Typography
            variant="h4"
            component="h1"
            sx={{
          ...
          <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
            ...
            <Button
              ...
              sx={{
                ...
                minWidth: "auto",
                px: 2,
                height: "48px", // <-- matches default TextField height
              }}
            >
              New Form
            </Button>
      ...
      {currentForm.fields.length === 0 ? (
        ...
        >
          ...
          >
            Add questions, customize settings, and create a form that works for
            you. Click the button below to add your first question.
          </Typography>
          <Button
            variant="contained"
            size="large"
          ...
          <Stack spacing={2} id="form-builder-field-list">
            <AnimatePresence initial={false}>
              {[...currentForm.fields]
                ...
                .map((field, index) => {
                  const isDragged =
                    draggedId === field.id && draggedIndex !== null;
                  return (
                    <motion.div
                      key={field.id}
                      layout
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        whileHover={
                          prefersReducedMotion ? undefined : { scale: 1.003 }
                        }
                        whileTap={
