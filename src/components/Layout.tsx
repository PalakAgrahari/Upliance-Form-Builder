...
import BuildIcon from "@mui/icons-material/EmojiObjects";
      ...
      >
        <Toolbar sx={{ px: 3 }}>
          <Box sx={{ display: "flex", alignItems: "center", mr: 3 }}>
            <Avatar sx={{ bgcolor: "#0078d4", mr: 1, width: 32, height: 32 }}>
          ...
          <Box sx={{ display: "flex", gap: 1 }}>
            ...
            <Button
              ...
              sx={{
                ...
                backgroundColor: isActive("/preview")
                  ? "rgba(0, 120, 212, 0.1)"
                  : "transparent",
                borderRadius: 20,
                px: 2,
            ...
            <Button
              ...
              sx={{
                ...
                backgroundColor: isActive("/myforms")
                  ? "rgba(0, 120, 212, 0.1)"
                  : "transparent",
                borderRadius: 20,
                px: 2,
