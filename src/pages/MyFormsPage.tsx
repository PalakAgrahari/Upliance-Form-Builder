    ...
    return (
      <Box sx={{ maxWidth: 800, mx: "auto" }}>
        ...
        <Paper sx={{ p: 6, textAlign: "center", borderRadius: 2 }}>
          ...
          >
            Start building beautiful forms to collect responses from your
            audience. Forms are easy to create and customize.
          </Typography>
          <Button
            variant="contained"
            size="large"
      ...
      >
        <Box>
          <Typography
            variant="h4"
            component="h1"
            sx={{ fontWeight: 600, mb: 1, color: "#0078d4" }}
          >
            My Forms
          </Typography>
                ...
                >
                  <CardContent sx={{ flexGrow: 1, p: 3 }}>
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      >
                        <Chip
                          label={`${form.fields.length} question${
